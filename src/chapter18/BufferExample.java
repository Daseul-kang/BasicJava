...
public class BufferExample {
    public static void main(String[] args) throws Exception {
        ...
        FileOutputStream fileOutputStream1 = new FileOutputStream("/home/pc15/바탕화면/sky1.mp4");
        ...
        FileOutputStream fileOutputStream2 = new FileOutputStream("/home/pc15/바탕화면/sky2.mp4");
        ...
        BufferedInputStream bis = new BufferedInputStream(new FileInputStream("sky.mp4"));
        BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream("/home/pc15/바탕화면/sky2.mp4"));
